...
export interface BabeCall_report_equivocation {
  ...
  equivocationProof: EquivocationProof_134
...
export interface GrandpaCall_report_equivocation {
  __kind: 'report_equivocation'
  equivocationProof: EquivocationProof_166
  keyOwnerProof: MembershipProof
}
...
export interface EquivocationProof_134 {
  offender: Uint8Array
  slot: Slot
  firstHeader: Header
  secondHeader: Header
...
export interface EquivocationProof_166 {
  setId: bigint
  equivocation: Equivocation_167
}
...
export type Equivocation_167 = Equivocation_167_Prevote | Equivocation_167_Precommit

export interface Equivocation_167_Prevote {
  __kind: 'Prevote'
  value: Equivocation_168
}

export interface Equivocation_167_Precommit {
  __kind: 'Precommit'
  value: Equivocation_168
}
...
export interface Equivocation_168 {
  roundNumber: bigint
  identity: Uint8Array
