...
export interface Type_28_Purchase {
  __kind: 'Purchase'
  value: PurchaseCall
}
...
export interface Type_188_Purchase {
  __kind: 'Purchase'
  value: PurchaseCall
}
