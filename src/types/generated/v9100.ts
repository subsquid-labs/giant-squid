...
export interface Type_125_Configuration {
  __kind: 'Configuration'
  value: ConfigurationCall
}

export interface Type_125_ParaInherent {
  __kind: 'ParaInherent'
...
export interface Type_125_Initializer {
  __kind: 'Initializer'
  value: InitializerCall
}

export interface Type_125_Ump {
  __kind: 'Ump'
  value: UmpCall
}

export interface Type_125_Hrmp {
  __kind: 'Hrmp'
  value: HrmpCall
}
...
export interface Type_124_Configuration {
  __kind: 'Configuration'
  value: ConfigurationCall
}

export interface Type_124_ParaInherent {
  __kind: 'ParaInherent'
  value: ParaInherentCall
}
...
export interface Type_124_Initializer {
  __kind: 'Initializer'
  value: InitializerCall
}

export interface Type_124_Ump {
  __kind: 'Ump'
  value: UmpCall
}

export interface Type_124_Hrmp {
  __kind: 'Hrmp'
  value: HrmpCall
}
...
export type XcmV1_422 = XcmV1_422_WithdrawAsset | XcmV1_422_ReserveAssetDeposit | XcmV1_422_ReceiveTeleportedAsset | XcmV1_422_QueryResponse | XcmV1_422_TransferAsset | XcmV1_422_TransferReserveAsset | XcmV1_422_Transact | XcmV1_422_HrmpNewChannelOpenRequest | XcmV1_422_HrmpChannelAccepted | XcmV1_422_HrmpChannelClosing | XcmV1_422_RelayedFrom

export interface XcmV1_422_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: MultiAssetV1[]
  effects: XcmOrderV1[]
}

export interface XcmV1_422_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit'
  assets: MultiAssetV1[]
  effects: XcmOrderV1[]
}

export interface XcmV1_422_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  assets: MultiAssetV1[]
  effects: XcmOrderV1[]
}

export interface XcmV1_422_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: ResponseV1
}

export interface XcmV1_422_TransferAsset {
  __kind: 'TransferAsset'
  assets: MultiAssetV1[]
  dest: MultiLocationV1
}

export interface XcmV1_422_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: MultiAssetV1[]
  dest: MultiLocationV1
  effects: XcmOrderV1[]
...
export interface XcmV1_422_Transact {
  __kind: 'Transact'
  originType: XcmOriginKind
  requireWeightAtMost: bigint
  call: DoubleEncodedCall
...
export interface XcmV1_422_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface XcmV1_422_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface XcmV1_422_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface XcmV1_422_RelayedFrom {
  __kind: 'RelayedFrom'
  who: MultiLocationV1
  message: XcmV1_422
}
