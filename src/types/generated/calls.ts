...
export class BalancesForceTransferCall {
  ...
  get asLatest(): {source: v32.MultiAddress, dest: v32.MultiAddress, value: bigint} {
    deprecateLatest()
    return this.asV32
  }
}
...
export class BalancesTransferCall {
  ...
  get asLatest(): {dest: v32.MultiAddress, value: bigint} {
    deprecateLatest()
    return this.asV32
  }
}
...
export class BalancesTransferAllCall {
   ...
   *    #</weight>
   */
  get asV2(): {dest: v2.GenericMultiAddress, keepAlive: boolean} {
    assert(this.isV2)
    return this.ctx._chain.decodeCall(this.ctx.extrinsic)
  }
  ...
  get asLatest(): {dest: v32.MultiAddress, keepAlive: boolean} {
    deprecateLatest()
    return this.asV32
  }
}
