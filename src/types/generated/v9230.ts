...
export interface BabeCall_report_equivocation {
  ...
  equivocationProof: EquivocationProof_180
...
export interface StakingCall_set_staking_configs {
  ...
  minNominatorBond: ConfigOp_201
  minValidatorBond: ConfigOp_201
  maxNominatorCount: ConfigOp_202
  maxValidatorCount: ConfigOp_202
  chillThreshold: ConfigOp_203
  minCommission: ConfigOp_202
}
...
export interface GrandpaCall_report_equivocation {
  __kind: 'report_equivocation'
  equivocationProof: EquivocationProof_211
  keyOwnerProof: MembershipProof
}
...
export interface EquivocationProof_180 {
  offender: Uint8Array
  slot: Slot
  firstHeader: Header
  secondHeader: Header
...
export type ConfigOp_201 = ConfigOp_201_Noop | ConfigOp_201_Set | ConfigOp_201_Remove

export interface ConfigOp_201_Noop {
  __kind: 'Noop'
}

export interface ConfigOp_201_Set {
  __kind: 'Set'
  value: bigint
}

export interface ConfigOp_201_Remove {
  __kind: 'Remove'
}

export type ConfigOp_202 = ConfigOp_202_Noop | ConfigOp_202_Set | ConfigOp_202_Remove

export interface ConfigOp_202_Noop {
  __kind: 'Noop'
}

export interface ConfigOp_202_Set {
  __kind: 'Set'
  value: number
}

export interface ConfigOp_202_Remove {
  __kind: 'Remove'
}

export type ConfigOp_203 = ConfigOp_203_Noop | ConfigOp_203_Set | ConfigOp_203_Remove

export interface ConfigOp_203_Noop {
  __kind: 'Noop'
}

export interface ConfigOp_203_Set {
  __kind: 'Set'
  value: Percent
}

export interface ConfigOp_203_Remove {
  __kind: 'Remove'
}
...
export interface SessionKeys {
  ...
  paraAssignment: V2Public
  authorityDiscovery: Uint8Array
}

export interface EquivocationProof_211 {
  setId: bigint
  equivocation: Equivocation_212
}
...
export type V2Signature = Uint8Array
...
export type VersionedXcm_413 = VersionedXcm_413_V0 | VersionedXcm_413_V1 | VersionedXcm_413_V2

export interface VersionedXcm_413_V0 {
  __kind: 'V0'
  value: V0Xcm_414
}

export interface VersionedXcm_413_V1 {
  __kind: 'V1'
  value: V1Xcm_419
}

export interface VersionedXcm_413_V2 {
  __kind: 'V2'
  value: V2Instruction_126[]
}
...
export type VersionedXcm_424 = VersionedXcm_424_V0 | VersionedXcm_424_V1 | VersionedXcm_424_V2

export interface VersionedXcm_424_V0 {
  __kind: 'V0'
  value: V0Xcm_425
}

export interface VersionedXcm_424_V1 {
  __kind: 'V1'
  value: V1Xcm_430
}

export interface VersionedXcm_424_V2 {
  __kind: 'V2'
  value: V2Instruction_436[]
}
...
export type V2Public = Uint8Array

export type Equivocation_212 = Equivocation_212_Prevote | Equivocation_212_Precommit

export interface Equivocation_212_Prevote {
  __kind: 'Prevote'
  value: Equivocation_213
}

export interface Equivocation_212_Precommit {
  __kind: 'Precommit'
  value: Equivocation_213
}
...
export type RawOrigin_250 = RawOrigin_250_Root | RawOrigin_250_Signed | RawOrigin_250_None

export interface RawOrigin_250_Root {
  __kind: 'Root'
}

export interface RawOrigin_250_Signed {
  __kind: 'Signed'
  value: AccountId32
}

export interface RawOrigin_250_None {
  __kind: 'None'
}

export type RawOrigin_251 = RawOrigin_251_Members | RawOrigin_251_Member | RawOrigin_251__Phantom

export interface RawOrigin_251_Members {
  __kind: 'Members'
  value: [number, number]
}

export interface RawOrigin_251_Member {
  __kind: 'Member'
  value: AccountId32
}

export interface RawOrigin_251__Phantom {
  __kind: '_Phantom'
}

export type Origin_253 = Origin_253_Parachain

export interface Origin_253_Parachain {
  __kind: 'Parachain'
  value: Id
}

export type Origin_254 = Origin_254_Xcm | Origin_254_Response

export interface Origin_254_Xcm {
  __kind: 'Xcm'
  value: V1MultiLocation
}

export interface Origin_254_Response {
  __kind: 'Response'
  value: V1MultiLocation
}
...
export type V0Xcm_414 = V0Xcm_414_WithdrawAsset | V0Xcm_414_ReserveAssetDeposit | V0Xcm_414_TeleportAsset | V0Xcm_414_QueryResponse | V0Xcm_414_TransferAsset | V0Xcm_414_TransferReserveAsset | V0Xcm_414_Transact | V0Xcm_414_HrmpNewChannelOpenRequest | V0Xcm_414_HrmpChannelAccepted | V0Xcm_414_HrmpChannelClosing | V0Xcm_414_RelayedFrom

export interface V0Xcm_414_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V0MultiAsset[]
  effects: V0Order_416[]
}

export interface V0Xcm_414_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit'
  assets: V0MultiAsset[]
  effects: V0Order_416[]
}

export interface V0Xcm_414_TeleportAsset {
  __kind: 'TeleportAsset'
  assets: V0MultiAsset[]
  effects: V0Order_416[]
}

export interface V0Xcm_414_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V0Response
}

export interface V0Xcm_414_TransferAsset {
  __kind: 'TransferAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Xcm_414_TransferReserveAsset {
...
export interface V0Xcm_414_Transact {
  __kind: 'Transact'
...
export interface V0Xcm_414_HrmpNewChannelOpenRequest {
...
export interface V0Xcm_414_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V0Xcm_414_HrmpChannelClosing {
...
export interface V0Xcm_414_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V0MultiLocation
  message: V0Xcm_414
}

export type V1Xcm_419 = V1Xcm_419_WithdrawAsset | V1Xcm_419_ReserveAssetDeposited | V1Xcm_419_ReceiveTeleportedAsset | V1Xcm_419_QueryResponse | V1Xcm_419_TransferAsset | V1Xcm_419_TransferReserveAsset | V1Xcm_419_Transact | V1Xcm_419_HrmpNewChannelOpenRequest | V1Xcm_419_HrmpChannelAccepted | V1Xcm_419_HrmpChannelClosing | V1Xcm_419_RelayedFrom | V1Xcm_419_SubscribeVersion | V1Xcm_419_UnsubscribeVersion

export interface V1Xcm_419_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V1MultiAssets
  effects: V1Order_421[]
}

export interface V1Xcm_419_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  assets: V1MultiAssets
  effects: V1Order_421[]
}

export interface V1Xcm_419_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  assets: V1MultiAssets
  effects: V1Order_421[]
}

export interface V1Xcm_419_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V1Response
}

export interface V1Xcm_419_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V1Xcm_419_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
...
export interface V1Xcm_419_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V1Xcm_419_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V1Xcm_419_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V1Xcm_419_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V1Xcm_419_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V1Junctions
  message: V1Xcm_419
}

export interface V1Xcm_419_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V1Xcm_419_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}

export type V2Instruction_126 = V2Instruction_126_WithdrawAsset | V2Instruction_126_ReserveAssetDeposited | V2Instruction_126_ReceiveTeleportedAsset | V2Instruction_126_QueryResponse | V2Instruction_126_TransferAsset | V2Instruction_126_TransferReserveAsset | V2Instruction_126_Transact | V2Instruction_126_HrmpNewChannelOpenRequest | V2Instruction_126_HrmpChannelAccepted | V2Instruction_126_HrmpChannelClosing | V2Instruction_126_ClearOrigin | V2Instruction_126_DescendOrigin | V2Instruction_126_ReportError | V2Instruction_126_DepositAsset | V2Instruction_126_DepositReserveAsset | V2Instruction_126_ExchangeAsset | V2Instruction_126_InitiateReserveWithdraw | V2Instruction_126_InitiateTeleport | V2Instruction_126_QueryHolding | V2Instruction_126_BuyExecution | V2Instruction_126_RefundSurplus | V2Instruction_126_SetErrorHandler | V2Instruction_126_SetAppendix | V2Instruction_126_ClearError | V2Instruction_126_ClaimAsset | V2Instruction_126_Trap | V2Instruction_126_SubscribeVersion | V2Instruction_126_UnsubscribeVersion

export interface V2Instruction_126_WithdrawAsset {
  __kind: 'WithdrawAsset'
  value: V1MultiAssets
}

export interface V2Instruction_126_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  value: V1MultiAssets
}

export interface V2Instruction_126_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  value: V1MultiAssets
}

export interface V2Instruction_126_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V2Response
  maxWeight: bigint
...
export interface V2Instruction_126_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V2Instruction_126_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  xcm: V2Instruction_126[]
}

export interface V2Instruction_126_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V2Instruction_126_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V2Instruction_126_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V2Instruction_126_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V2Instruction_126_ClearOrigin {
  __kind: 'ClearOrigin'
}

export interface V2Instruction_126_DescendOrigin {
  __kind: 'DescendOrigin'
  value: V1Junctions
}

export interface V2Instruction_126_ReportError {
  __kind: 'ReportError'
  queryId: bigint
  dest: V1MultiLocation
  maxResponseWeight: bigint
...
export interface V2Instruction_126_DepositAsset {
  __kind: 'DepositAsset'
...
export interface V2Instruction_126_DepositReserveAsset {
...
export interface V2Instruction_126_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V2Instruction_126_InitiateReserveWithdraw {
...
export interface V2Instruction_126_InitiateTeleport {
...
export interface V2Instruction_126_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V2Instruction_126_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weightLimit: V2WeightLimit
}

export interface V2Instruction_126_RefundSurplus {
  __kind: 'RefundSurplus'
}

export interface V2Instruction_126_SetErrorHandler {
  __kind: 'SetErrorHandler'
  value: V2Instruction_126[]
}

export interface V2Instruction_126_SetAppendix {
  __kind: 'SetAppendix'
  value: V2Instruction_126[]
}

export interface V2Instruction_126_ClearError {
  __kind: 'ClearError'
}

export interface V2Instruction_126_ClaimAsset {
  __kind: 'ClaimAsset'
  assets: V1MultiAssets
  ticket: V1MultiLocation
}

export interface V2Instruction_126_Trap {
  __kind: 'Trap'
  value: bigint
}

export interface V2Instruction_126_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V2Instruction_126_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}
...
export type V0Xcm_425 = V0Xcm_425_WithdrawAsset | V0Xcm_425_ReserveAssetDeposit | V0Xcm_425_TeleportAsset | V0Xcm_425_QueryResponse | V0Xcm_425_TransferAsset | V0Xcm_425_TransferReserveAsset | V0Xcm_425_Transact | V0Xcm_425_HrmpNewChannelOpenRequest | V0Xcm_425_HrmpChannelAccepted | V0Xcm_425_HrmpChannelClosing | V0Xcm_425_RelayedFrom

export interface V0Xcm_425_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V0MultiAsset[]
  effects: V0Order_427[]
}

export interface V0Xcm_425_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit'
  assets: V0MultiAsset[]
  effects: V0Order_427[]
}

export interface V0Xcm_425_TeleportAsset {
  __kind: 'TeleportAsset'
  assets: V0MultiAsset[]
  effects: V0Order_427[]
}

export interface V0Xcm_425_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V0Response
}

export interface V0Xcm_425_TransferAsset {
  __kind: 'TransferAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Xcm_425_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_416[]
...
export interface V0Xcm_425_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V0Xcm_425_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V0Xcm_425_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V0Xcm_425_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V0Xcm_425_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V0MultiLocation
  message: V0Xcm_425
}

export type V1Xcm_430 = V1Xcm_430_WithdrawAsset | V1Xcm_430_ReserveAssetDeposited | V1Xcm_430_ReceiveTeleportedAsset | V1Xcm_430_QueryResponse | V1Xcm_430_TransferAsset | V1Xcm_430_TransferReserveAsset | V1Xcm_430_Transact | V1Xcm_430_HrmpNewChannelOpenRequest | V1Xcm_430_HrmpChannelAccepted | V1Xcm_430_HrmpChannelClosing | V1Xcm_430_RelayedFrom | V1Xcm_430_SubscribeVersion | V1Xcm_430_UnsubscribeVersion

export interface V1Xcm_430_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V1MultiAssets
  effects: V1Order_432[]
}

export interface V1Xcm_430_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  assets: V1MultiAssets
  effects: V1Order_432[]
}

export interface V1Xcm_430_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  assets: V1MultiAssets
  effects: V1Order_432[]
}

export interface V1Xcm_430_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V1Response
}

export interface V1Xcm_430_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V1Xcm_430_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  effects: V1Order_421[]
...
export interface V1Xcm_430_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V1Xcm_430_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V1Xcm_430_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V1Xcm_430_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V1Xcm_430_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V1Junctions
  message: V1Xcm_430
}

export interface V1Xcm_430_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V1Xcm_430_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}

export type V2Instruction_436 = V2Instruction_436_WithdrawAsset | V2Instruction_436_ReserveAssetDeposited | V2Instruction_436_ReceiveTeleportedAsset | V2Instruction_436_QueryResponse | V2Instruction_436_TransferAsset | V2Instruction_436_TransferReserveAsset | V2Instruction_436_Transact | V2Instruction_436_HrmpNewChannelOpenRequest | V2Instruction_436_HrmpChannelAccepted | V2Instruction_436_HrmpChannelClosing | V2Instruction_436_ClearOrigin | V2Instruction_436_DescendOrigin | V2Instruction_436_ReportError | V2Instruction_436_DepositAsset | V2Instruction_436_DepositReserveAsset | V2Instruction_436_ExchangeAsset | V2Instruction_436_InitiateReserveWithdraw | V2Instruction_436_InitiateTeleport | V2Instruction_436_QueryHolding | V2Instruction_436_BuyExecution | V2Instruction_436_RefundSurplus | V2Instruction_436_SetErrorHandler | V2Instruction_436_SetAppendix | V2Instruction_436_ClearError | V2Instruction_436_ClaimAsset | V2Instruction_436_Trap | V2Instruction_436_SubscribeVersion | V2Instruction_436_UnsubscribeVersion

export interface V2Instruction_436_WithdrawAsset {
  __kind: 'WithdrawAsset'
  value: V1MultiAssets
}

export interface V2Instruction_436_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  value: V1MultiAssets
}

export interface V2Instruction_436_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  value: V1MultiAssets
}

export interface V2Instruction_436_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V2Response
  maxWeight: bigint
...
export interface V2Instruction_436_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V2Instruction_436_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  xcm: V2Instruction_126[]
...
export interface V2Instruction_436_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V2Instruction_436_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V2Instruction_436_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V2Instruction_436_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V2Instruction_436_ClearOrigin {
  __kind: 'ClearOrigin'
}

export interface V2Instruction_436_DescendOrigin {
  __kind: 'DescendOrigin'
  value: V1Junctions
}

export interface V2Instruction_436_ReportError {
  __kind: 'ReportError'
  queryId: bigint
  dest: V1MultiLocation
  maxResponseWeight: bigint
...
export interface V2Instruction_436_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V2Instruction_436_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V2Instruction_436_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V2Instruction_436_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  xcm: V2Instruction_126[]
...
export interface V2Instruction_436_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  xcm: V2Instruction_126[]
...
export interface V2Instruction_436_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V2Instruction_436_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weightLimit: V2WeightLimit
}

export interface V2Instruction_436_RefundSurplus {
  __kind: 'RefundSurplus'
}

export interface V2Instruction_436_SetErrorHandler {
  __kind: 'SetErrorHandler'
  value: V2Instruction_436[]
}

export interface V2Instruction_436_SetAppendix {
  __kind: 'SetAppendix'
  value: V2Instruction_436[]
}

export interface V2Instruction_436_ClearError {
  __kind: 'ClearError'
}

export interface V2Instruction_436_ClaimAsset {
  __kind: 'ClaimAsset'
  assets: V1MultiAssets
  ticket: V1MultiLocation
}

export interface V2Instruction_436_Trap {
  __kind: 'Trap'
  value: bigint
}

export interface V2Instruction_436_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V2Instruction_436_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}
...
export interface Equivocation_213 {
  roundNumber: bigint
  identity: Uint8Array
...
export type V0Order_416 = V0Order_416_Null | V0Order_416_DepositAsset | V0Order_416_DepositReserveAsset | V0Order_416_ExchangeAsset | V0Order_416_InitiateReserveWithdraw | V0Order_416_InitiateTeleport | V0Order_416_QueryHolding | V0Order_416_BuyExecution

export interface V0Order_416_Null {
  __kind: 'Null'
}

export interface V0Order_416_DepositAsset {
  __kind: 'DepositAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Order_416_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_416[]
...
export interface V0Order_416_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V0MultiAsset[]
  receive: V0MultiAsset[]
}

export interface V0Order_416_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V0MultiAsset[]
...
export interface V0Order_416_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_416[]
...
export interface V0Order_416_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V0MultiLocation
  assets: V0MultiAsset[]
...
export interface V0Order_416_BuyExecution {
  __kind: 'BuyExecution'
  fees: V0MultiAsset
  weight: bigint
  debt: bigint
...
export type V1Order_421 = V1Order_421_Noop | V1Order_421_DepositAsset | V1Order_421_DepositReserveAsset | V1Order_421_ExchangeAsset | V1Order_421_InitiateReserveWithdraw | V1Order_421_InitiateTeleport | V1Order_421_QueryHolding | V1Order_421_BuyExecution

export interface V1Order_421_Noop {
  __kind: 'Noop'
}

export interface V1Order_421_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V1Order_421_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V1Order_421_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V1Order_421_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  effects: V1Order_421[]
...
export interface V1Order_421_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  effects: V1Order_421[]
...
export interface V1Order_421_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V1Order_421_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weight: bigint
  debt: bigint
  haltOnError: boolean
  instructions: V1Xcm_419[]
}
...
export type V0Order_427 = V0Order_427_Null | V0Order_427_DepositAsset | V0Order_427_DepositReserveAsset | V0Order_427_ExchangeAsset | V0Order_427_InitiateReserveWithdraw | V0Order_427_InitiateTeleport | V0Order_427_QueryHolding | V0Order_427_BuyExecution

export interface V0Order_427_Null {
  __kind: 'Null'
}

export interface V0Order_427_DepositAsset {
  __kind: 'DepositAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Order_427_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_416[]
...
export interface V0Order_427_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V0MultiAsset[]
  receive: V0MultiAsset[]
}

export interface V0Order_427_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V0MultiAsset[]
  reserve: V0MultiLocation
  effects: V0Order_416[]
...
export interface V0Order_427_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_416[]
...
export interface V0Order_427_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V0MultiLocation
  assets: V0MultiAsset[]
...
export interface V0Order_427_BuyExecution {
  __kind: 'BuyExecution'
  fees: V0MultiAsset
  weight: bigint
  debt: bigint
...
export type V1Order_432 = V1Order_432_Noop | V1Order_432_DepositAsset | V1Order_432_DepositReserveAsset | V1Order_432_ExchangeAsset | V1Order_432_InitiateReserveWithdraw | V1Order_432_InitiateTeleport | V1Order_432_QueryHolding | V1Order_432_BuyExecution

export interface V1Order_432_Noop {
  __kind: 'Noop'
}

export interface V1Order_432_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V1Order_432_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V1Order_432_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V1Order_432_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  effects: V1Order_421[]
...
export interface V1Order_432_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  effects: V1Order_421[]
...
export interface V1Order_432_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V1Order_432_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weight: bigint
  debt: bigint
  haltOnError: boolean
  instructions: V1Xcm_430[]
}
