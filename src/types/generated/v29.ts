...
export type Type_28 = Type_28_System | Type_28_Scheduler | Type_28_Babe | Type_28_Timestamp | Type_28_Indices | Type_28_Balances | Type_28_Authorship | Type_28_Staking | Type_28_Offences | Type_28_Session | Type_28_Grandpa | Type_28_ImOnline | Type_28_AuthorityDiscovery | Type_28_Democracy | Type_28_Council | Type_28_TechnicalCommittee | Type_28_ElectionsPhragmen | Type_28_TechnicalMembership | Type_28_Treasury | Type_28_Claims | Type_28_Vesting | Type_28_Utility | Type_28_Identity | Type_28_Proxy | Type_28_Multisig | Type_28_Bounties | Type_28_Tips | Type_28_ElectionProviderMultiPhase
...
export type Type_193 = Type_193_System | Type_193_Scheduler | Type_193_Babe | Type_193_Timestamp | Type_193_Indices | Type_193_Balances | Type_193_Authorship | Type_193_Staking | Type_193_Offences | Type_193_Session | Type_193_Grandpa | Type_193_ImOnline | Type_193_AuthorityDiscovery | Type_193_Democracy | Type_193_Council | Type_193_TechnicalCommittee | Type_193_ElectionsPhragmen | Type_193_TechnicalMembership | Type_193_Treasury | Type_193_Claims | Type_193_Vesting | Type_193_Utility | Type_193_Identity | Type_193_Proxy | Type_193_Multisig | Type_193_Bounties | Type_193_Tips | Type_193_ElectionProviderMultiPhase

export interface Type_193_System {
  __kind: 'System'
  value: SystemCall
}

export interface Type_193_Scheduler {
  __kind: 'Scheduler'
  value: SchedulerCall
}

export interface Type_193_Babe {
  __kind: 'Babe'
  value: BabeCall
}

export interface Type_193_Timestamp {
  __kind: 'Timestamp'
  value: TimestampCall
}

export interface Type_193_Indices {
  __kind: 'Indices'
  value: IndicesCall
}

export interface Type_193_Balances {
  __kind: 'Balances'
  value: BalancesCall
}

export interface Type_193_Authorship {
  __kind: 'Authorship'
  value: AuthorshipCall
}

export interface Type_193_Staking {
  __kind: 'Staking'
  value: StakingCall
}

export interface Type_193_Offences {
  __kind: 'Offences'
  value: OffencesCall
}

export interface Type_193_Session {
  __kind: 'Session'
  value: SessionCall
}

export interface Type_193_Grandpa {
  __kind: 'Grandpa'
  value: GrandpaCall
}

export interface Type_193_ImOnline {
  __kind: 'ImOnline'
  value: ImOnlineCall
}

export interface Type_193_AuthorityDiscovery {
  __kind: 'AuthorityDiscovery'
  value: AuthorityDiscoveryCall
}

export interface Type_193_Democracy {
  __kind: 'Democracy'
  value: DemocracyCall
}

export interface Type_193_Council {
  __kind: 'Council'
  value: CouncilCall
}

export interface Type_193_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeCall
}

export interface Type_193_ElectionsPhragmen {
  __kind: 'ElectionsPhragmen'
  value: ElectionsPhragmenCall
}

export interface Type_193_TechnicalMembership {
  __kind: 'TechnicalMembership'
  value: TechnicalMembershipCall
}

export interface Type_193_Treasury {
  __kind: 'Treasury'
  value: TreasuryCall
}

export interface Type_193_Claims {
  __kind: 'Claims'
  value: ClaimsCall
}

export interface Type_193_Vesting {
  __kind: 'Vesting'
  value: VestingCall
}

export interface Type_193_Utility {
  __kind: 'Utility'
  value: UtilityCall
}

export interface Type_193_Identity {
  __kind: 'Identity'
  value: IdentityCall
}

export interface Type_193_Proxy {
  __kind: 'Proxy'
  value: ProxyCall
}

export interface Type_193_Multisig {
  __kind: 'Multisig'
  value: MultisigCall
}

export interface Type_193_Bounties {
  __kind: 'Bounties'
  value: BountiesCall
}

export interface Type_193_Tips {
  __kind: 'Tips'
  value: TipsCall
}

export interface Type_193_ElectionProviderMultiPhase {
  __kind: 'ElectionProviderMultiPhase'
  value: ElectionProviderMultiPhaseCall
}
