...
export class ParachainStakingCollatorStateStorage {
   ...
   */
  get isV49() {
    return this._chain.getStorageItemTypeHash('ParachainStaking', 'CollatorState') === 'e021f25b8536c116b9fa878663be6fd4f263d9d967d77a19134dc59a9cee73f6'
  }
  ...
  async getAsV49(key: Uint8Array): Promise<v49.Collator | undefined> {
    assert(this.isV49)
    return this._chain.getStorage(this.blockHash, 'ParachainStaking', 'CollatorState', key)
  }

  async getManyAsV49(keys: Uint8Array[]): Promise<(v49.Collator | undefined)[]> {
    assert(this.isV49)
    return this._chain.queryStorage(this.blockHash, 'ParachainStaking', 'CollatorState', keys.map(k => [k]))
  }

  async getAllAsV49(): Promise<(v49.Collator)[]> {
    assert(this.isV49)
    return this._chain.queryStorage(this.blockHash, 'ParachainStaking', 'CollatorState')
  }
   ...
   */
  get isExists(): boolean {
    return this._chain.getStorageItemTypeHash('ParachainStaking', 'CollatorState') != null
  }
}
...
export class ParachainStakingCollatorState2Storage {
  ...
  async getAllAsV53(): Promise<(v53.Collator2)[]> {
    assert(this.isV53)
...
export class ParachainStakingNominatorStateStorage {
   ...
   */
  get isV49() {
    return this._chain.getStorageItemTypeHash('ParachainStaking', 'NominatorState') === 'f801fe87581f7dbb6db044ddd5a7adbe0d0ea1596ad42a8ccd22aa28f6be3e8f'
  }
  ...
  async getAllAsV49(): Promise<(v49.Nominator)[]> {
    assert(this.isV49)
...
export class ParachainStakingNominatorState2Storage {
  ...
  async getAllAsV200(): Promise<(v200.Nominator2)[]> {
    assert(this.isV200)
...
export class ParachainStakingSelectedCandidatesStorage {
   ...
   *  The collator candidates selected for the current round
   */
  async getAsV49(): Promise<Uint8Array[]> {
    assert(this.isV49)
