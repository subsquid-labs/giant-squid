...
export type XcmV1_395 = XcmV1_395_WithdrawAsset | XcmV1_395_ReserveAssetDeposit | XcmV1_395_ReceiveTeleportedAsset | XcmV1_395_QueryResponse | XcmV1_395_TransferAsset | XcmV1_395_TransferReserveAsset | XcmV1_395_Transact | XcmV1_395_HrmpNewChannelOpenRequest | XcmV1_395_HrmpChannelAccepted | XcmV1_395_HrmpChannelClosing | XcmV1_395_RelayedFrom

export interface XcmV1_395_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: MultiAssetV1[]
  effects: XcmOrderV1[]
}

export interface XcmV1_395_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit'
  assets: MultiAssetV1[]
  effects: XcmOrderV1[]
}

export interface XcmV1_395_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  assets: MultiAssetV1[]
  effects: XcmOrderV1[]
}

export interface XcmV1_395_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: ResponseV1
}

export interface XcmV1_395_TransferAsset {
  __kind: 'TransferAsset'
  assets: MultiAssetV1[]
  dest: MultiLocationV1
}

export interface XcmV1_395_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: MultiAssetV1[]
  dest: MultiLocationV1
  effects: XcmOrderV1[]
...
export interface XcmV1_395_Transact {
  __kind: 'Transact'
  originType: XcmOriginKind
  requireWeightAtMost: bigint
  call: DoubleEncodedCall
...
export interface XcmV1_395_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface XcmV1_395_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface XcmV1_395_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface XcmV1_395_RelayedFrom {
  __kind: 'RelayedFrom'
  who: MultiLocationV1
  message: XcmV1_395
}
