module.exports = class InitV3_1655367088606 {
  name = 'InitV3_1655367088606'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "round_nominator" ("id" character varying NOT NULL, "bond" numeric NOT NULL, "collators_count" integer NOT NULL, "round_id" character varying NOT NULL, "staker_id" character varying NOT NULL, CONSTRAINT "PK_198962b34d30551579fc4fc9d1c" PRIMARY KEY ("id"))`)
