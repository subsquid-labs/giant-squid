module.exports = class InitV3_1654973535483 {
  ...
  async up(db) {
    ...
    await db.query(`CREATE INDEX "IDX_6df781f6988651136911c74fd6" ON "crowdloan" ("start") `)
    ...
    await db.query(`CREATE TABLE "era_nomination" ("id" character varying NOT NULL, "vote" numeric NOT NULL, "era_id" character varying NOT NULL, "nominator_id" character varying, "validator_id" character varying, CONSTRAINT "PK_9e1ee04790eebb7d7cdd286b87c" PRIMARY KEY ("id"))`)
