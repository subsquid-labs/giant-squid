module.exports = class Data1665498587895 {
  name = 'Data1665498587895'

  async up(db) {
    await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_hash" text, "from_id" character varying NOT NULL, "to_id" character varying NOT NULL, "amount" numeric NOT NULL, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "account_transfer" ("id" character varying NOT NULL, "account_id" character varying NOT NULL, "direction" character varying(4), "transfer_id" character varying, CONSTRAINT "PK_3b959a286b97fc83be6cec239a9" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "parachain" ("id" character varying NOT NULL, CONSTRAINT "PK_0f6ac85862a6ca7c8873f699b61" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "crowdloan" ("id" character varying NOT NULL, "cap" numeric NOT NULL, "first_period" integer NOT NULL, "last_period" integer NOT NULL, "created_at" integer, "created_at_timestamp" TIMESTAMP WITH TIME ZONE, "ended_at" integer, "ended_at_timestamp" TIMESTAMP WITH TIME ZONE, "raised" numeric NOT NULL, "parachain_id" character varying, "status" character varying(9) NOT NULL, "synced_at" integer NOT NULL, CONSTRAINT "PK_19a05e349701577c8c1679ae84d" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "contribution" ("id" character varying NOT NULL, "crowdloan_id" character varying, "account_id" character varying NOT NULL, "amount" numeric NOT NULL, "contributor_id" character varying, CONSTRAINT "PK_878330fa5bb34475732a5883d58" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "contributor" ("id" character varying NOT NULL, "crowdloan_id" character varying, "account_id" character varying NOT NULL, "amount" numeric NOT NULL, CONSTRAINT "PK_816afef005b8100becacdeb6e58" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "slash" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE, "block_number" integer, "extrinsic_hash" text, "account_id" character varying NOT NULL, "amount" numeric NOT NULL, "era" integer, "staker_id" character varying NOT NULL, CONSTRAINT "PK_21170fe23f4bb830eaaff8bd4e9" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "staker" ("id" character varying NOT NULL, "stash_id" character varying NOT NULL, "controller_id" character varying, "payee_id" character varying, "payee_type" character varying(10), "role" character varying(9), "commission" integer, "active_bond" numeric NOT NULL, "total_reward" numeric NOT NULL, "total_slash" numeric NOT NULL, "synced_at" integer NOT NULL, CONSTRAINT "REL_828b14269265a736e4fef52ce2" UNIQUE ("stash_id"), CONSTRAINT "PK_13561f691b22038cfa606fe1161" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "reward" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE, "block_number" integer, "extrinsic_hash" text, "account_id" character varying, "amount" numeric NOT NULL, "era" integer, "validator_id" text, "staker_id" character varying NOT NULL, CONSTRAINT "PK_a90ea606c229e380fb341838036" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "synced_at" integer NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
