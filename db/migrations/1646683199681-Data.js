module.exports = class Data1646683199681 {
  name = 'Data1646683199681'

  async up(db) {
    await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "chain_name" text, "date" TIMESTAMP WITH TIME ZONE, "block_number" numeric, "extrinsic_hash" text, "amount" numeric, "success" boolean, "name" text, "to_id" character varying, "from_id" character varying, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "stake" ("id" character varying NOT NULL, "chain_name" text, "date" TIMESTAMP WITH TIME ZONE, "block_number" numeric, "extrinsic_hash" text, "amount" numeric, "total" numeric, "success" boolean, "name" text, "account_id" character varying, CONSTRAINT "PK_8cfd82a65916af9d517d25a894e" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "total_stake" numeric, "total_reward" numeric, "total_slash" numeric, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
