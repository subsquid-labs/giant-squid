module.exports = class InitV2_1653758718191 {
  name = 'InitV2_1653758718191'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "reward" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE, "block_number" numeric, "extrinsic_hash" text, "account_id" character varying NOT NULL, "amount" numeric, "round" integer, "validator" text, "total" numeric, "name" text, CONSTRAINT "PK_a90ea606c229e380fb341838036" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "bond" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE, "block_number" numeric, "extrinsic_hash" text, "account_id" character varying NOT NULL, "amount" numeric, "total" numeric, "success" boolean, "type" character varying(6), "candidate" text, CONSTRAINT "PK_2a4d050cae7f0326222053ae2b4" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "active_bond" numeric NOT NULL, "total_reward" numeric NOT NULL, "last_update_block" numeric NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
